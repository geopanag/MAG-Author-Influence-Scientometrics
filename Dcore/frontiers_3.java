...
//                    System.out.println("not found");
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, Exception {
        ...
        PrintWriter author_frontiers = new PrintWriter(new File("/storage3/dcore/author_frontiers_ids1.csv"));
        PrintWriter core_sizes = new PrintWriter(new File("/storage3/dcore/core_sizes_ids1.csv"));
        String directory;
        int start, end;
//        storage2:
